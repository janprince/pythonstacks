!function (e, i, n) {
    ...
    "use strict";
    return function (e) {
        var i = [], t = [], s = e, a = "", l = "", o = 0, r = 500, d = function (e) {
...
$.fn.scrollEnd = function (e, i) {
    ...
    window.requestAnimationFrame || (window.requestAnimationFrame = function (i, n) {
        let t = (new Date).getTime(), s = Math.max(0, 16 - (t - e)), a = window.setTimeout(function () {
            i(t + s)
        }, s);
        return e = t + s, a
...
!function (e) {
    ...
    SEMICOLON.initialize = {
        init: function () {
            ...
            let t, s = Function("return " + n.pluginfn)(), a = "js/", l = !1;
        ...
        init: function () {
            ...
            n.children().css({display: "block"}), n.css({display: "block"}), n.each(function (i, n) {
                let t = e(n), s = t.offset(), a = t.width();
            ...
            let i, n = e(".menu-item:has(.sub-menu-container)"), t = n.children(".menu-link"),
                s = ".mega-menu-content, .sub-menu-container", a = e(s), l = ".menu-item",
            ...
            }, 1e3), b.find(a).css({display: ""})) : c.css({"margin-top": ""}), o.hasClass("overlay-menu") && b.hasClass("on-click") && (o.hasClass("device-xl") || o.hasClass("device-lg")) ? t.off("click").on("click", function (i) {
                let n = e(this);
            ...
            }), e(".menu-container:not(.mobile-primary-menu)").css({display: ""}), (o.hasClass("device-xl") || o.hasClass("device-lg")) && b.find(".mobile-primary-menu").removeClass("d-block")
            ...
            if (l.scrollTop() > e) if (o.hasClass("device-xl") || o.hasClass("device-lg")) {
        ...
        init: function () {
            ...
            let e = Q.outerHeight(), i = Q.outerWidth(), n = Q.find(".slider-inner"), t = W.find(".swiper-wrapper"),
                s = W.find(".swiper-slide").first(), a = W.hasClass("h-auto") || W.hasClass("min-vh-0");
            ...
            let e, i, n = SEMICOLON.slider.sliderParallaxOffset(), a = Q.outerHeight();
            ...
            if (Q.length < 1) return !0;
            if (!o.hasClass("device-xl") && !o.hasClass("device-lg") || SEMICOLON.isMobile.any()) Q.find(".slider-arrow-left,.slider-arrow-right,.slider-caption,.slider-element-fade").css({opacity: 1}); else {
        ...
        init: function () {
            ...
            i.each(function () {
                e(this).find(".portfolio-item").each(function () {
                    let i = e(this).find(".portfolio-desc"), n = i.outerHeight();
        ...
        init: function () {
            ...
            let i = setInterval(function () {
                "pluginBootstrapReady" in scwEvents && (e().tooltip ? e('[data-bs-toggle="tooltip"]').tooltip({container: "body"}) : console.log("extras: Bootstrap Tooltip not defined."), e().popover ? e('[data-bs-toggle="popover"]').popover({container: "body"}) : console.log("extras: Bootstrap Popover not defined."), clearInterval(i))
            }, 1e3);
            if (e(".style-msg").on("click", ".close", function (i) {
                ...
                let i = e("[data-adaptive-light-class], [data-adaptive-dark-class]"),
                    n = i.attr("data-adaptive-light-class"), t = i.attr("data-adaptive-dark-class"), s = function (e) {
        ...
        init: function () {
            ...
            }, {passive: true}), window.addEventListener("DOMContentLoaded", onScrollSliderParallax, !1), l.scrollEnd(function () {
                let e = u.outerHeight();
    ...
    let i, n, t, s, a, l = e(window), o = e("body"), r = e("#wrapper"), d = e("#header"), u = e("#header-wrap"),
        ...
        y = "", E = (u.outerHeight(), u.find(".header-row:eq(0)"), e("#content"), e("#footer")), N = l.width(),
